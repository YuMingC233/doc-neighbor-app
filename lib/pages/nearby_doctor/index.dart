            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.center, // bg-red-100
                  child: Column(
                    children: [
                      Text(
                        "紧急求助已发送",
                ...
                Padding(
                  padding:
                      const EdgeInsets.fromLTRB(16, 16, 16, 26), // 增加底部边距到26dp
                  child: SizedBox(
                    width: double.infinity,
                    child: ElevatedButton(
                      onPressed: cancelEmergency,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFFD1D5DB), // bg-gray-300
                        foregroundColor:
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFFDCFCE7), // bg-green-100
              borderRadius: BorderRadius.circular(8),
            ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                        "${acceptedDoctor!.name} (${acceptedDoctor!.specialty})"),
                  ],
                ),
                const SizedBox(height: 8),
                Text(
